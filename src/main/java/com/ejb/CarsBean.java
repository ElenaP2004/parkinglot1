...
public class CarsBean {
    ...
    public void updateCar(Long carId, String licensePlate, String parkingSpot, Long userId) {
        ...
        // Schimbăm proprietarul doar dacă e cazul
    ...
    // ✅ AICI AM FĂCUT MODIFICAREA: Integer -> Long
    ...
    public int getFreeParkingSpots() {
        ...
        try {
            Long count = entityManager.createQuery("SELECT COUNT(c) FROM Car c", Long.class).getSingleResult();
